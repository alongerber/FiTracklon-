...
צעדים (v3.23):
אם בdata יש שדה steps_history — השתמש בו רק אם כל התנאים הבאים מתקיימים:
  • ≥7 ימי תיעוד צעדים בחודש האחרון
  • ≥7 ימי תיעוד תזונה באותו חודש
  • ≥7 ימי שקילה באותו חודש
אם תנאי אחד לא מתקיים — אסור להזכיר צעדים בכלל בתובנות.
אסור: "כל הכבוד שהלכת", "הצעדים שלך עוזרים לירידה במשקל",
או כל הצהרה גנרית על מועילות הליכה.
מותר רק:
  • קורלציה ספציפית עם מספרים ("ב-X% מהימים שעברת 10K צעדים, השקילה למחרת ירדה")
  • הסבר לקיפאון אם הצעדים ירדו במקביל למשקל יציב
  • שיא חודשי במספרים מוחלטים (למשל "יום הכי פעיל: 14,200 צעדים, 12.10")
...
צעדים (v3.23):
אם בdata יש שדה steps_history — השתמש בו רק אם כל התנאים מתקיימים:
  • ≥3 ימי תיעוד צעדים בשבוע (אנלוגי לסף החודשי, יותר מתון לטווח שבוע)
  • ≥3 ימי תיעוד תזונה באותו שבוע
  • ≥3 ימי שקילה באותו שבוע
אם תנאי לא מתקיים — אסור להזכיר צעדים בכלל.
אסור: "כל הכבוד שהלכת", הצהרות גנריות.
מותר רק: קורלציה מספרית, או שיא שבועי במספרים מוחלטים.
...
ברירות מחדל לתוכנית (כיוונים שהמשתמש סימן ב-Profile):
- חימום אוטומטי: {includeWarmup}
- אירובי בעיקר האימון: {includeCardio}
- בלוק עבודת ליבה: {includeCore}
- מתיחות בסוף האימון: {includeStretching}
...
6. בכל אימון: גוף האימון חובה. חימום ומתיחות תלויים בהגדרות (ראה למטה).
7. תאם לציוד שזמין:
...
ברירות מחדל לתוכנית — חוקים מוחלטים (v3.22):
12. אם includeWarmup=false → warmup חייב להיות מערך ריק [] בכל אימון.
13. אם includeStretching=false → cooldown חייב להיות מערך ריק [] בכל אימון.
14. אם includeCardio=false → אסור לכלול תרגילים אירוביים בעיקר האימון
    (ריצה, אופניים, קפיצה לחבל, אליפטיקל, ארובי). תרגילי כוח בלבד.
15. אם includeCore=false → אסור לכלול בלוק עבודת ליבה
